...
class Snippet:
    ...
    def create_full_user(self, data_u):
        ...
        file_name = str(i)+'.jpg'
        EXT_FILE_PATH = 'C:/Users/o_1ivka/Documents/Myweb/images/avs/'
    ...
    def auto_user(self):
        ...
        file_name = str(i)+'.jpg'
        EXT_FILE_PATH = 'C:/Users/o_1ivka/Documents/Myweb/images/country/'
        lf = self.tmpf(file_name,EXT_FILE_PATH)
        ...
        file_name = str(i)+'.jpg'
        EXT_FILE_PATH = 'C:/Users/o_1ivka/Documents/Myweb/images/region/'
        lf = self.tmpf(file_name,EXT_FILE_PATH)
